    ...
    <Spin spinning={loading}>
      ...
      >
        <Form form={form} onFinish={onFinish}>
          <Form.Item label="ID" name="id" rules={[{ required: true, message: '请输入车辆ID' }]}>
            <Input />
          </Form.Item>
          <Form.Item label="客户ID" name="customerId" rules={[{ required: true, message: '请输入客户ID' }]}>
            <Input />
          </Form.Item>
          <Form.Item label="品牌" name="model" rules={[{required:true,message:"请输入车辆品牌"}]}>
            <Input />
          </Form.Item>
          <Form.Item label="车牌号" name="licensePlate" rules={[{required:true,message:"请输入车牌号"}]}>
            <Input/>
          </Form.Item>
          <Form.Item label="VIN码" name="vin" rules={[{required:true,message:"请输入车辆VIN码"}]}>
            <Input/>
          </Form.Item>
          <Form.Item>
