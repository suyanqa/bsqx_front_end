...
const EditableTable = () => {
  ...
  const onFinish = (values) => {
    axios.post(`/api/inbound/edit/${selectedItem.id}`, values)
      .then(response => {
    ...
    <Spin spinning={loading}>
      ...
      >
        <Form form={form} onFinish={onFinish}>
          <Form.Item label="ID" name="id" rules={[{ required: true, message: '请输入入库ID' }]}>
            <Input />
          </Form.Item>
          ...
          <Form.Item label="日期" name="inboundDate" rules={[{required:true,message:"请输入入库日期YYYY-MM-DD"}]}>
            <Input/>
          </Form.Item>
          <Form.Item>
